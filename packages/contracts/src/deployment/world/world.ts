...
import droptables from "./data/items/Droptables.csv";
import items from "./data/items/Items.csv";
import background from "./data/kami/Background.csv";
import body from "./data/kami/Body.csv";
import color from "./data/kami/Color.csv";
import face from "./data/kami/Face.csv";
import hand from "./data/kami/Hand.csv";
import nodes from "./data/nodes/Nodes.csv";
import maps from "./data/rooms/Maps.csv";
import rooms from "./data/rooms/Rooms.csv";
