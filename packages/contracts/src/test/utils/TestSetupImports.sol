...
import { ERC20MintSystem, ID as ERC20MintSystemID } from "systems/ERC20MintSystem.sol";
import { ERC20BurnSystem, ID as ERC20BurnSystemID } from "systems/ERC20BurnSystem.sol";
...
ERC20MintSystem _ERC20MintSystem;
ERC20BurnSystem _ERC20BurnSystem;
...
_ERC20MintSystem = ERC20MintSystem(system(ERC20MintSystemID));
_ERC20BurnSystem = ERC20BurnSystem(system(ERC20BurnSystemID));
