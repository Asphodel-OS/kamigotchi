...
import { IsDescriptionComponent, ID as IsDescriptionComponentID } from "components/IsDescriptionComponent.sol";
...
import { _RegistryCreateSkillDescriptionSystem, ID as _RegistryCreateSkillDescriptionSystemID } from "systems/_RegistryCreateSkillDescriptionSystem.sol";
...
IsDescriptionComponent _IsDescriptionComponent;
...
_RegistryCreateSkillDescriptionSystem __RegistryCreateSkillDescriptionSystem;
...
_IsDescriptionComponent = IsDescriptionComponent(component(IsDescriptionComponentID));
...
__RegistryCreateSkillDescriptionSystem = _RegistryCreateSkillDescriptionSystem(system(_RegistryCreateSkillDescriptionSystemID));
