...
import { ProxyDKGPermissionsComponent, ID as ProxyDKGPermissionsComponentID } from "components/ProxyDKGPermissionsComponent.sol";
...
import { RandomDKGProxySystem, ID as RandomDKGProxySystemID } from "systems/RandomDKGProxySystem.sol";
...
ProxyDKGPermissionsComponent _ProxyDKGPermissionsComponent;
...
RandomDKGProxySystem _RandomDKGProxySystem;
...
_ProxyDKGPermissionsComponent = ProxyDKGPermissionsComponent(component(ProxyDKGPermissionsComponentID));
...
_RandomDKGProxySystem = RandomDKGProxySystem(system(RandomDKGProxySystemID));
