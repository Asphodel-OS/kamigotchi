...
import { ValueSignedComponent as SignedValComp, ID as IntBalCompID } from "components/ValueSignedComponent.sol";
...
library LibBonus {
  ...
  function inc(IUintComp components, uint256 holderID, string memory type_, int256 amt) internal {
    ...
    SignedValComp comp = SignedValComp(getAddressById(components, IntBalCompID));
