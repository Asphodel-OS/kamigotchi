...
library LibCoin {
  /// @notice gets the coin balance of an entity
  ...
  /// @notice transfers the specified coin amt from=>to entity
  ...
  /// @notice increases the coin balance of an entity by amt
  ...
  /// @notice decreases the coin balance of an entity by amt
  ...
  /// @notice sets the coin balance of an entity
