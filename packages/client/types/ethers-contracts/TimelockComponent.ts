...
export type TimelockOpStructOutput = [
  target: string,
  value: bigint,
  salt: bigint
] & { target: string; value: bigint; salt: bigint };

export interface TimelockComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, TimelockOpStruct]
  ): string;
  encodeFunctionData(
...
export interface TimelockComponent extends BaseContract {
  connect(runner?: ContractRunner | null): TimelockComponent;
  ...
  "getEntitiesWithValue((address,uint256,uint256))": TypedContractMethod<
  ...
  "set(uint256,(address,uint256,uint256))": TypedContractMethod<
    [entity: BigNumberish, value: TimelockOpStruct],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getEntitiesWithValue((address,uint256,uint256))"
  ): TypedContractMethod<[value: TimelockOpStruct], [bigint[]], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "set(uint256,(address,uint256,uint256))"
  ): TypedContractMethod<
    [entity: BigNumberish, value: TimelockOpStruct],
    [void],
    "nonpayable"
