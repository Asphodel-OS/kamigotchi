...
export interface KamiSendSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "executeTyped(uint32,address)",
...
export interface KamiSendSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiSendSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiSendSystemInterface;
  ...
  "executeTyped(uint32,address)": TypedContractMethod<
    [kamiIndex: BigNumberish, toAddress: AddressLike],
    [string],
    "nonpayable"
  >;

  "executeTyped(uint32[],address)": TypedContractMethod<
    [kamiIndices: BigNumberish[], toAddress: AddressLike],
    [string],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "executeTyped(uint32,address)"
  ): TypedContractMethod<
    [kamiIndex: BigNumberish, toAddress: AddressLike],
    [string],
    "nonpayable"
