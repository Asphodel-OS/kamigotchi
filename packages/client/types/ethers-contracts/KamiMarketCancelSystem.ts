...
export interface KamiMarketCancelSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiMarketCancelSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiMarketCancelSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiMarketCancelSystemInterface;
