...
export interface CompoundComponentInterface extends utils.Interface {
  functions: {
...
export interface CompoundComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundComponentInterface;
