...
export interface IndexRewardComponentInterface extends utils.Interface {
  functions: {
...
export interface IndexRewardComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexRewardComponentInterface;
