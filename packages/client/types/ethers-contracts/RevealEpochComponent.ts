...
export interface RevealEpochComponentInterface extends utils.Interface {
  functions: {
...
export interface RevealEpochComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RevealEpochComponentInterface;
