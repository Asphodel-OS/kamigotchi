...
export interface KamiMarketOfferSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "executeTypedCollection",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "executeTypedOffer",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
...
export interface KamiMarketOfferSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiMarketOfferSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiMarketOfferSystemInterface;
  ...
  executeTypedCollection: TypedContractMethod<
    [price: BigNumberish, quantity: BigNumberish, expiry: BigNumberish],
    [string],
    "nonpayable"
  >;

  executeTypedOffer: TypedContractMethod<
    [kamiIndex: BigNumberish, price: BigNumberish, expiry: BigNumberish],
    [string],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "executeTypedCollection"
  ): TypedContractMethod<
    [price: BigNumberish, quantity: BigNumberish, expiry: BigNumberish],
    [string],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "executeTypedOffer"
  ): TypedContractMethod<
    [kamiIndex: BigNumberish, price: BigNumberish, expiry: BigNumberish],
    [string],
    "nonpayable"
