...
export interface _ShapeRegistrySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addFlag"
      | "addOwnerComp"
...
export interface _ShapeRegistrySystem extends BaseContract {
  connect(runner?: ContractRunner | null): _ShapeRegistrySystem;
  waitForDeployment(): Promise<this>;

  interface: _ShapeRegistrySystemInterface;
  ...
  addFlag: TypedContractMethod<
    [type_: string, flagType: string],
    [void],
    "nonpayable"
  >;

  addOwnerComp: TypedContractMethod<
    [type_: string, ownerCompID: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  executeTyped: TypedContractMethod<
    [type_: string, description: string],
    [string],
    "nonpayable"
  >;
  ...
  remove: TypedContractMethod<[type_: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[type_: string], [void], "nonpayable">;
  getFunction(
