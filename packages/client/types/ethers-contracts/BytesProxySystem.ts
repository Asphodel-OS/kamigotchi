...
export interface BytesProxySystemInterface extends utils.Interface {
  functions: {
...
export interface BytesProxySystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BytesProxySystemInterface;
