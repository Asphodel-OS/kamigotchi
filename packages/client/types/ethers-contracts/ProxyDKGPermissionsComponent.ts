...
export interface ProxyDKGPermissionsComponentInterface extends utils.Interface {
  functions: {
...
export interface ProxyDKGPermissionsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyDKGPermissionsComponentInterface;
