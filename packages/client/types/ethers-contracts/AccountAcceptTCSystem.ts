...
export interface AccountAcceptTCSystemInterface extends utils.Interface {
  functions: {
...
export interface AccountAcceptTCSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountAcceptTCSystemInterface;
