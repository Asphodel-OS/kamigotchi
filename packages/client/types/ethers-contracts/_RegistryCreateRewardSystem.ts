...
export interface _RegistryCreateRewardSystemInterface extends utils.Interface {
  functions: {
...
export interface _RegistryCreateRewardSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _RegistryCreateRewardSystemInterface;
