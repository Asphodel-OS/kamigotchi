...
export interface QuestRequirementsComponentInterface extends utils.Interface {
  functions: {
...
export interface QuestRequirementsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QuestRequirementsComponentInterface;
