...
export interface KamiUseEnemyItemSystemInterface extends utils.Interface {
  functions: {
...
export interface KamiUseEnemyItemSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KamiUseEnemyItemSystemInterface;
