...
export interface IDOwnsKamiOrderComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IDOwnsKamiOrderComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IDOwnsKamiOrderComponent;
  waitForDeployment(): Promise<this>;

  interface: IDOwnsKamiOrderComponentInterface;
