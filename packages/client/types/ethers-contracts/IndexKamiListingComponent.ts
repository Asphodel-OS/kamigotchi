...
export interface IndexKamiListingComponentInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeWriter"
...
export interface IndexKamiListingComponent extends BaseContract {
  connect(runner?: ContractRunner | null): IndexKamiListingComponent;
  waitForDeployment(): Promise<this>;

  interface: IndexKamiListingComponentInterface;
