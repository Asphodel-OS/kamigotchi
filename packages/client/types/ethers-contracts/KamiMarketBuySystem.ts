...
export interface KamiMarketBuySystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiMarketBuySystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiMarketBuySystem;
  waitForDeployment(): Promise<this>;

  interface: KamiMarketBuySystemInterface;
  ...
  ): TypedContractMethod<[listingIDs: BigNumberish[]], [string], "payable">;
  getFunction(
