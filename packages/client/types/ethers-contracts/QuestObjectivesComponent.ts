...
export interface QuestObjectivesComponentInterface extends utils.Interface {
  functions: {
...
export interface QuestObjectivesComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: QuestObjectivesComponentInterface;
