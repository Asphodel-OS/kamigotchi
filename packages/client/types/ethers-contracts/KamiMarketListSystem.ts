...
export interface KamiMarketListSystemInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface KamiMarketListSystem extends BaseContract {
  connect(runner?: ContractRunner | null): KamiMarketListSystem;
  waitForDeployment(): Promise<this>;

  interface: KamiMarketListSystemInterface;
