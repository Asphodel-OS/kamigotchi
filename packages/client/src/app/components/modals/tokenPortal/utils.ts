...
export const openBaselineLink = (address: string) => {
  const urlOld = `https://app.baseline.markets/trade/yominet/${address}`;
  const urlNew = `https://app.baseline.markets/tokens/1/0x80Ea38D56E262457D73c0d8dFe027AE8925821e2?tab=buy&view=trade`;
