...
import { BaseKami, queryKamis } from 'network/shapes/Kami';
...
export function registerGachaModal() {
  registerUIComponent(
    ...
    (layers) =>
      interval(1000).pipe(
        map(() => {
          ...
          const kamiOptions = { live: 0, stats: 3600, traits: 3600 };
    ...
    ({ network, data, tokens, utils }) => {
      ...
      const handleReroll = async (kamis: BaseKami[]) => {
