...
import { getItemAlloParentID, getItemReqParentID } from './utils';
...
export const getUsecaseRequirements = (
  ...
  const parentID = getItemReqParentID(itemIndex, usecase);
...
export const getUsecaseAllos = (
  ...
  const parentID = getItemAlloParentID(itemIndex, usecase);
