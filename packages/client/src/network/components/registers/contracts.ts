...
export function createContractComponents(world: World) {
  return {
    _DepreciatedIsLog: defineBoolComponent(world, '_DepreciatedIsLog', 'component.is.log'),
    _DepreciatedIsLootbox: defineBoolComponent(
      world,
      '_DepreciatedIsLootbox',
      'component.is.lootbox'
    ),
    _DepreciatedIsObjective: defineBoolComponent(
      world,
      '_DepreciatedIsObjective',
      'component.is.objective'
    ),
    _DepreciatedIsRequirement: defineBoolComponent(
      world,
      '_DepreciatedIsRequirement',
    ...
    ForID: defineNumberComponent(world, 'ForID', 'component.for'),
    ...
    OwnsRelationshipID: defineStringComponent(
      world,
      'OwnsRelationshipID',
    ...
    ProxyPermissionsFarm20: defineBoolComponent(
      world,
      'ProxyPermissionsFarm20',
      'components.proxy.Permissions.Farm20'
    ),
    ...
    ProxyPermissionsMint20: defineBoolComponent(
      world,
      'ProxyPermissionsMint20',
      'components.proxy.Permissions.Mint20'
    ),
